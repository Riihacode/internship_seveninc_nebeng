...
data class CreatePassengerTransactionResponse(
	@field:SerializedName("data") val data: DataCreatePassengerTransaction
)

data class DataCreatePassengerTransaction(
