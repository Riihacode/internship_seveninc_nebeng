...
//                    is Result.Success -> _uiState.updateSuccess(
//                        auth = result.data,
...
//                    is Result.Success -> _uiState.updateSuccess(
//                        auth = result.data,
//                        successMessage = null // tidak perlu notif saat get profile
//                    )
//                }
//            }
//        }
...
//        val baseAuth = _uiState.value.auth
//        viewModelScope.launch {
//            useCases.updateCustomerProfile(token, userId, request, baseAuth).collectLatest { result ->
//                when (result) {
//                    is Result.Loading -> _uiState.updateLoading()
//                    is Result.Error -> _uiState.updateError(result.message)
//                    is Result.Success -> _uiState.updateSuccess(
...
//
//    /** ------------------------------------------------------------------
//     * 🔥 UTIL: CLEAR SUCCESS & ERROR STATE
//     * ------------------------------------------------------------------ */
//    fun resetMessages() {
...
//
//    // ============================================================
//    // PRIVATE EXTENSIONS for cleaner reducer-like state updates
//    // ============================================================
