...
data class ReadByPassengerRideBookingIdPassengerTransactionResponse(
	@field:SerializedName("data") val data: DataByPassengerRideId
)

data class DataByPassengerRideId(
