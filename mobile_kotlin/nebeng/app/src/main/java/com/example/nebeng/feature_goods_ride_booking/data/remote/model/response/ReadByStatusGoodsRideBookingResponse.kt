...
data class ReadByStatusGoodsRideBookingResponse(
	@field:SerializedName("data") val data: List<DataItemReadByStatus>
)

data class DataItemReadByStatus(
	...
	@field:SerializedName("goods_ride") val goodsRide: GoodsRideByStatus,
