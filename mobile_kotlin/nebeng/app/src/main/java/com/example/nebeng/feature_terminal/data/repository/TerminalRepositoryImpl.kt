...
import com.example.nebeng.feature_terminal.data.remote.model.mapper.TerminalMapper
    ...
    override suspend fun getAllTerminal(token: String): Flow<Result<List<Terminal>>> =
        flow {
            ...
            try {
                ...
                val terminals = TerminalMapper.toDomainList(response.data)
    ...
    override suspend fun getTerminalById(token: String, id: Int): Flow<Result<Terminal>> =
        flow {
            ...
            try {
                ...
                val terminal = TerminalMapper.toDomain(response.data)
