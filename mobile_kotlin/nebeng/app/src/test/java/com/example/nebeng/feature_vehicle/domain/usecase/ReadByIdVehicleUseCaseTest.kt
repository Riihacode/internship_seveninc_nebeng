...
class ReadByIdVehicleUseCaseTest {

    @Mock private lateinit var repository: VehicleRepository
    private lateinit var useCase: ReadByIdVehicleUseCase

    @Before
    fun setup() {
        MockitoAnnotations.openMocks(this)
        useCase = ReadByIdVehicleUseCase(repository)
    }
    ...
    fun `invoke emits Success`() = runTest {
        ...
        whenever(repository.getVehicleById(token, id)).thenReturn(flow {
